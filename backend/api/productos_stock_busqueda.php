...
$sql = "SELECT p.id_producto, p.nombre, p.codigo_barras, p.cantidad_por_unidad, p.tipo_medida, s.cantidad_actual
        FROM productos p
        INNER JOIN stocks s ON p.id_producto = s.id_producto1
        WHERE p.activo = 1
