...
<head>
    ...
    <title>Detalles de Entrada - SoftCare</title>
...
<body>
    <main>
        ...
        <section class="secciones-area-gestion">
            <h2 class="titulo-dashboard">Detalles de la Entrada N°[id_entrada]</h2> <!-- Variable -->
            <section class="seccion1-busqueda-agregar">
                ...
                <a href="">
                    <button class="registrar-btn">Registrar Producto de la Entrada</button>
                </a>
            </section>
            <table class="tabla-entradas-detalles">
                <thead class="header-tabla-entradas-detalles">
                    <tr>
                        <td>Producto</td>
                        <td>Cantidad</td>
                ...
                <tbody class="body-tabla-entradas-detalles">
    ...
    <aside class="modal-entrada-detalle-editar">
        <a href="">
            <img class="volver-icono" src="" alt="">
            <h2>Volver</h2>
        </a>
        <h1 class="modal-edped-titulo">
            Editar Producto en la Entrada N°[Id_entrada] <!-- Variable-->
        </h1>
        <form class="edped-form" action="" method=""> <!-- Formulario -->
            <section class="edped-form-inputs-area">
                ...
                <!---->
                <label class="edped-label" for="">Motivo de Entrada</label>
                ...
                <!---->
                <label class="edped-label" for="">N° de Entrada</label>
                <div class="union-input-icono">
                    <input class="edped-input5" type="text" name="edped-id_entrada" value="[id_entrada]"> <!--En el value="" va el id de la entrada registrado-->
                    <figure class="candado-icono">
                        <img class="candado-icono-img" src="" alt="">
                    </figure>
                </div>
