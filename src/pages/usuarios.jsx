...
export const Usuarios = () => {
  ...
  const abrirModal = (num, usuario = null) => {
    ...
    if (num == 1) {
      setFormRegistrar({
        ...formRegistrar,
        contraseña: setContrasenaGenerada(),
      });
    }
    if (num === 2 && usuario) {
      setFormEditar({
  ...
  const handleEditar = (e) => {
    ...
    enviar(
      "PUT",
      { id_usuario: usuarioSeleccionado.id_usuario, ...formEditar },
      ...
      >
        ...
        {modalActiva === 1 && (
          <aside className="modal-usuarios-registrar">
            ...
            <h1 className="modal-usr-titulo">Registre un Usuario</h1>
            {mensajeExito && (
            ...
            <form className="usr-form" onSubmit={handleRegistrar}>
              <section className="usr-form-inputs-area">
                <div style={{ gridArea: "divInpt1" }}>
                  <label className="usr-label" for="">
                    Nombre del Usuario<h6 className="obligatorio">*</h6>
                  </label>
                  <input
                    className="usr-input1"
                    type="text"
                ...
                <div style={{ gridArea: "divInpt2" }}>
                  <label className="usr-label" for="">
                    Correo<h6 className="obligatorio">*</h6>
                  </label>
                  <input
                    className="usr-input2"
                    type="text"
                ...
                <div style={{ gridArea: "divInpt3" }}>
                  <label className="usr-label" for="">
                    Contraseña<h6 className="obligatorio">*</h6>
                  </label>
                  <div className="union-input-icono">
                    <input
                      className="usr-input3"
                      type="text"
                      value={formRegistrar.contraseña}
                      readOnly
                    />
                ...
                >
                  <label className="usr-label" for="">
                    Rol<h6 className="obligatorio">*</h6>
                  </label>
                  <CustomSelect
                    options={opcionesRoles}
                    value={formRegistrar.rol}
                    onChange={(value) =>
              ...
              <input
                className="usr-btn"
                type="submit"
                value={cargando ? "Enviando..." : "Registrar usuario"}
                disabled={cargando}
              />
            </form>
          </aside>
        ...
        {modalActiva === 2 && (
          <aside className="modal-usuarios-editar">
            ...
            <h1 className="modal-used-titulo">Editar Usuario Registrado</h1>
            ...
            <form className="used-form" onSubmit={handleEditar}>
              <section className="used-form-inputs-area">
                <div style={{ gridArea: "divInpt1" }}>
                  <label className="used-label" for="">
                    Nombre del Usuario<h6 className="obligatorio">*</h6>
                  </label>
                  <input
                    className="used-input1"
                    type="text"
        ...
        {modalActiva === 3 && (
          <aside className="modal-usuarios-desactivar">
            ...
            <h3 className="modal-usel-mensaje">
              ¿Desea desactivar a &nbsp;
              <h6 className="subrayar">{usuarioSeleccionado.nombre}</h6>?
            </h3>
